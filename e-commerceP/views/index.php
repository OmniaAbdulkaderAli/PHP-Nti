...
<div class="product-area bg-image-1 pt-100 pb-95">
    ...
    <h2 > Recent Products </h2>
        ...
        <?php $getRecentProduct = $productObject->getRecentProduct();
        if($getRecentProduct){
            $products = $getRecentProduct->fetch_all(MYSQLI_ASSOC);
            foreach($products as $index=> $product){?>

              
<div class="product-wrapper mr-4">
        ...
        }else{echo "<div class='alert alert-warning'> there is no products available </div>";}
    ...
    <div class="container">
        ...
        <div class="tab-content jump">
            <div class="tab-pane active">
                ...
                <?php $getMostRatedProduct = $productObject->mostRatedProduct();
        if($getMostRatedProduct){
            $products = $getMostRatedProduct->fetch_all(MYSQLI_ASSOC);
            foreach($products as $index=> $product){?>
<div class="product-wrapper-single">
                        <div class="product-wrapper mb-30 ml-2">
                            <div class="product-img">
                                <a href="product-details.php">
                                    <img alt="" src="../assets/img/product/<?php echo $product['image']; ?>">
                                </a>
                            ...
                            <div class="product-content text-left">
                                <div class="product-hover-style">
                                    <div class="product-title">
                                        ...
                                        <h4>
                                              <?php echo $product['reviews_count'] ?> customers has reviewd this product
                                        </h4>
                                    </div>
                                    <div class="cart-hover">
                                        <h4><a href="product-details.php">+ Add to cart</a></h4>
